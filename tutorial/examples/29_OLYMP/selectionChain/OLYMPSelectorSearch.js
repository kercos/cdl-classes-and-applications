...
var classes = {
    ...
    OLYMPSearchThemeMatrix: o(
        {
            "class": o("OLYMPSearchThemeMatrixDesign", "OLYMPThemeMatrix"),
            context: {
                // the selector search area using this matrix (at most one
                // at a time)
                searchAt: [first,
                           [{ isOpen: true },
                            [areaOfClass, "OLYMPInterventionFieldSearch"]]],
    ...
    OLYMPInterventionFieldSearch: o(
        {
            "class": o("OLYMPInterventionFieldSearchDesign"),
    ...
    OLYMPInterventionFieldSearchDesign: o(
        {
            ...
            children: {
                openAndCloseButton: { description: {
                    "class": "OLYMPInterventionFieldSearchOpenCloseButton",
                    position: {
                        left: 0,
                        right: 0,
                        top: 0,
    ...
    OLYMPInterventionFieldSearchOpenCloseButton: o(
        {
            context: {
                    ...
                    display: {
                        triangle: {
                            ...
                            color: [
                                ...
                                [my, "OLYMPInterventionFieldSearchDesign"]]
                        }
                    }
                }}
            }

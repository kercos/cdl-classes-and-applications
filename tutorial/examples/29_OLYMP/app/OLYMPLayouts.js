...
var classes = {
    ...
    OLYMPSingleViewLayout: o(
        {
            "class": o("OLYMPSelectorDesignContext",
            ...
            children: {
                view: { description: {
                    "class": "OLYMPView",
                    context: {
                        // This provide the OLYMPView class access to the
                        // view properties
                ...
                selectors: { description: {
                    "class": o("OLYMPSliceEditor",
                               "OLYMPSingleViewSliceEditorLayout"),
                    context: {
    ...
    OLYMPSingleViewSliceEditorLayout: o({
